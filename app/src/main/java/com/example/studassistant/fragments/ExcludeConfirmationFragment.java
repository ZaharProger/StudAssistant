...
public class ExcludeConfirmationFragment extends DialogFragment implements View.OnClickListener{
    ...
    private ProgressBar excludeProgressBar;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        excludeProgressBar = view.findViewById(R.id.deleteProgressBar);
        excludeProgressBar.setVisibility(View.INVISIBLE);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.delete_yes_button) {
            excludeProgressBar.setVisibility(View.VISIBLE);
